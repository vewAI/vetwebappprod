...
/**
 * Local template generation is deprecated for safety and validation reasons.
 * All autogenerated case content must be sourced from the Merck Veterinary
 * Manual via the server-side Merck search + generator. This helper now
