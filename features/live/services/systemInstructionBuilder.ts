...
export function buildPersonaSystemInstruction(params: {
  ...
  const instruction = [
    ...
    "- RESULTS ARE VERBAL (STRICT): Whenever you mention that results, findings or values are available, posted or on the panel, you MUST also SAY the actual values out loud (e.g. 'Temp is 38.9, heart rate 110, the CBC shows…'). Never just tell the student to look them up — speak every value you are sharing.",
