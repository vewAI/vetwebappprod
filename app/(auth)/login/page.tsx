...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/90   to-primary/70 flex flex-col items-center justify-center p-4">
      ...
      <div className="mb-4 flex flex-row items-center gap-2 motion-safe:animate-in motion-safe:fade-in-50 motion-safe:slide-in-from-top-4">
        ...
        <h2 className="text-4xl text-white tracking-tight">
          Vew<span className="text-primary font-bold">Ai</span>
        </h2>
      </div>
      ...
      <div className="mb-8 text-center motion-safe:animate-in motion-safe:fade-in-50 motion-safe:slide-in-from-top-4">
        ...
        <p className="text-white/80 text-lg typewriter-text overflow-hidden">AI-powered educational simulator for veterinary students</p>
      </div>
