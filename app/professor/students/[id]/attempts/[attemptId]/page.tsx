...
import { getAttemptById, updateProfessorFeedback } from '@/features/attempts/services/attemptService';
import { Attempt, AttemptMessage, AttemptFeedback } from '@/features/attempts/models/attempt';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="h-[600px] flex flex-col">
          ...
          <CardContent className="flex-1 overflow-y-auto space-y-4">
            {messages.map((msg) => (
              <div key={msg.id} className={`p-3 rounded-lg ${msg.role === 'user' ? 'bg-blue-50 ml-8' : 'bg-gray-50 mr-8'}`}>
                <p className="text-xs font-semibold mb-1">{msg.role === 'user' ? 'Student' : 'AI'}</p>
          ...
          <Card>
            ...
            <CardContent>
              {attempt.overallFeedback ? (
                ...
                <p className="text-muted-foreground">No overall feedback generated.</p>
              )}
            </CardContent>
          </Card>
